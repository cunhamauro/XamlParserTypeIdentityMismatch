...
public static class Main
{
  public static void Start()
  {
    ...
    WriteInfo($"AddinB expects {behaviorAssembly.GetName().Name} from {AssemblyLoadContext.GetLoadContext(behaviorAssembly)?.Name}");
    ...
    WriteInfo($"AddinB parser returned {parsed.GetType().Assembly.GetName().Name} from {AssemblyLoadContext.GetLoadContext(parsed.GetType().Assembly)?.Name}");
